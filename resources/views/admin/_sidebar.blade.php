<div class="container-fluid page-body-wrapper">
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{asset('assets')}}/admin/pages/ui-features/typography.html">Typography</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{asset('assets')}}/admin/admin/pages/icons/mdi.html">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="auth">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{asset('assets')}}/admin/pages/samples/register-2.html"> Register 2 </a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{asset('assets')}}/admin/pages/samples/lock-screen.html"> Lockscreen </a>
                        </li>
                    </ul>
                </div>
            </li>
